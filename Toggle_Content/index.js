jQuery(function($){
    ...
    --------------------------------------------------
    */
    $(document.body).on("wpseedm_toggle_content", function(e, contentName, toggleContents, cbkBefore, cbkAfter){
    ...
    $(document.body).on("click", ".toggle-content-btn", function(e){
        ...
        $(document.body).trigger("wpseedm_toggle_content", [contentName, toggleContents]);
    });
